...
//			}
	...
	public static function pheonixBackupCronCheck($siteID){
		$where = array(
      		'query' =>  "siteID=':siteID' AND status IN('scheduled', 'running', 'initiated') AND action = 'pheonixBackupCron'",
      		'params' => array(
               ':siteID'=>$siteID
				)
		);
	...
	public static function pheonixBackupCronDoActionCheck($siteID){
		$where = array(
      		'query' =>  "siteID=':siteID' AND status IN('scheduled', 'running', 'initiated') AND action = 'pheonixBackupCronDoAction'",
      		'params' => array(
               ':siteID'=>$siteID
				)
		);
